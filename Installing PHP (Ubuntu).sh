...
apt install php8.5 php8.5-fpm php8.5-mbstring php-pear -y #php8.5-mysql libapache2-mod-php8.5 -y # Install PHP, PHP-FPM, PHP Extensions & PHP as an Apache module 
